...
import { BookOpen, PlusCircle, Users, Plus, LogOut, User as UserIcon, Menu, Archive } from 'lucide-react';
...
const Sidebar = ({ isCollapsed, onToggle }) => {
    ...
    return (
        <aside className={`bg-white border-r border-slate-200 h-screen sticky top-0 flex flex-col transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
            ...
            <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-8">
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link
                                ...
                                title={isCollapsed ? 'All Resources' : ''}
                            >
                                <BookOpen className="w-5 h-5" />
                                {!isCollapsed && <span>All Resources</span>}
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                title={isCollapsed ? 'Add Resources' : ''}
                            >
                                <PlusCircle className="w-5 h-5" />
                                {!isCollapsed && <span>Add Resources</span>}
                            </Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="mt-auto pt-4 border-t border-slate-100">
                    <Link
                        ...
                        title={isCollapsed ? 'Archived Resources' : ''}
                    >
                        <Archive className="w-5 h-5" />
                        {!isCollapsed && <span>Archived Resources</span>}
                    </Link>
                </div>
            </nav>
